...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { climate: @state.climate, culture: @state.culture, info: @state.info, language: @state.language, name: @state.name }
    end
  ...
  test "should update state" do
    patch :update, id: @state, state: { climate: @state.climate, culture: @state.culture, info: @state.info, language: @state.language, name: @state.name }
    assert_redirected_to state_path(assigns(:state))
  end
